...
|---|---:|---:|---:|---:|---:|
| Frozen docs | 63/69 | 63/69 | 6/69 | 6/69 | 0 |
| Authored adaptive | 16/24 | 20/24 | 6/24 | 2/24 | 0 |

- frozen exact evidence-span all-covered: **18/69 → 18/69**
- authored exact evidence-span all-covered: **6/24 → 7/24**
- authored exact-span false-full: **16/24 → 15/24**
- exact citations: **True**
- temporal violations zero: **True**
- frozen improvement IDs: `[]`
...
- frozen regression IDs: `[]`
- authored regression IDs: `[]`
- frozen new false-full IDs: `[]`
- authored new false-full IDs: `[]`
