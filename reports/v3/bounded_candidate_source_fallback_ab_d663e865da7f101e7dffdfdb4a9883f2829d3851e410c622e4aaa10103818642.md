...
| Docs grounded | 61/69 | 61/69 |
| Docs false-full | baseline | 8/69 |

Triggered 19 cases; committed 8. Decision: **DEVELOPMENT_NO_GO**.
...
- `authored_canary_sha256_8a4310949413526b4fbf0e6681e4757a0672373c26a1bdcc3c4afb72f1146d7a`: `['dnf_seria_shop']` → `['dnf_seria_shop', 'dnf_monthly_item']`, shape 2→3
...
- `retrieval_dev_sha256_f445f9f8c954555863d745271d649b3a355eabae395f907a575dcf21fa4c6342`: `['dnf_seria_shop']` → `['dnf_seria_shop', 'dnf_event']`, shape 1→2