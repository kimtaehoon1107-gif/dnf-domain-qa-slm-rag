...
- deterministic decomposition: **NO-GO**
- child source/time rerouting: **NO-GO**
- child BM25 evidence pilot: **NO-GO**
...
- parent source coverage errors: 2
- parent time coverage errors: 0
- evidence-group hit@10: 5/8
- child evidence-group specificity errors: 2
